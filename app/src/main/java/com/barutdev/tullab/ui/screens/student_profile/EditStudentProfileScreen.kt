...
import com.barutdev.tullab.ui.screens.student_profile.StudentProfileEvent
...
import com.barutdev.tullab.ui.screens.student_profile.components.ScheduledLessonsRatePromptDialog
...
fun EditStudentProfileScreen(
    ...
    val successMessage = tullabStringResource(id = R.string.student_profile_save_success)
    ...
    StudentProfileContent(
        title = tullabStringResource(id = R.string.student_profile_title),
        state = uiState,
        onBack = onBack,
...
fun StudentProfileContent(
    ...
    val backContentDescription = tullabStringResource(id = R.string.student_profile_back_content_description)
    val optionalLabel = tullabStringResource(id = R.string.student_profile_optional_label)
    val requiredIndicator = tullabStringResource(id = R.string.student_profile_required_indicator)
    ...
    Box(
        ...
        if (state.isLoading) {
            ...
            val parentContactLabel = tullabStringResource(id = R.string.student_profile_parent_contact_label)
            val hourlyRateLabel = tullabStringResource(id = R.string.student_profile_hourly_rate_label)
            val hourlyRateHelper = tullabStringResource(id = R.string.student_profile_hourly_rate_helper, defaultRateText)
            val notesLabel = tullabStringResource(id = R.string.student_profile_notes_label)
            val saveLabel = tullabStringResource(id = R.string.student_profile_save)
            ...
            Column(
                ...
                OutlinedTextField(
                    ...
                    supportingText = state.fullNameError?.let { errorRes ->
                        { Text(text = tullabStringResource(id = errorRes)) }
                    },
                ...
                OutlinedTextField(
                    ...
                    supportingText = {
                        ...
                        if (errorRes != null) {
                            Text(
                                text = tullabStringResource(id = errorRes),
